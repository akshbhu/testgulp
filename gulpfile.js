...
gulp.task('default', gulp.series(gulp.series(gulp.parallel('clean:packageLock', 'clean:dist', 'copy:all', 'copy:libs'), 'fileinclude', 'js', 'scss',  'html'), gulp.parallel('browsersync', 'watch')));
